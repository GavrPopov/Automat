import pytest
import requests
from Lesson_8_1.Pages.ClientsPage import Employer
from Lesson_8_1.Pages.ClientsPage import Company
...
def test_add_employer(get_token):
    ...
    body_employer = {
        ...
        'url': 'string',
        'phone': 'string',
        'birthdate': '1990-09-20T10:02:30.622Z',
        'isActive': 'true'
    }
...
def test_employers_missing_id_add_token():
    try:
        ...
        assert str(
            e) == "Employer.change_info() missing 3 required positional argument: 'employee_id'"
